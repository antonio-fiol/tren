...
if __name__ == "__main__":
    ...
    PlacaDesvios(0x20, {
            desvios[1]:  PlacaSalida(0,"A1"),
            desvios[2]:  PlacaSalida(0,"A2"),
            desvios[3]:  PlacaSalida(0,"A3"),
            desvios[4]:  PlacaSalida(0,"A4"),
            desvios[5]:  PlacaSalida(0,"A5"),
            desvios[6]:  PlacaSalida(0,"A6"),
            desvios[7]:  PlacaSalida(0,"B1"),
            desvios[8]:  PlacaSalida(0,"B2"),
            desvios[9]:  PlacaSalida(0,"B3"),
            desvios[10]: PlacaSalida(0,"B4"),
            desvios[11]: PlacaSalida(0,"B5"),
            desvios[12]: PlacaSalida(0,"B6"),
    },debug=True,i2cdebug=True)
